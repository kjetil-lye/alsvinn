...
size_t StructureBasic::getNumberOfGhostCells() const {
    return numberOfH;
}

size_t StructureBasic::computeStatisticsBorder(const alsfvm::volume::Volume&
    conservedVariablesInner, const alsfvm::volume::Volume& extraVariablesInner,
