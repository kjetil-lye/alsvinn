...
void FixedIntervalStatistics::setMpiSpatialConfiguration(
    const alsutils::mpi::ConfigurationPtr& value) {
    Statistics::setMpiSpatialConfiguration(value);

    statistics->setMpiSpatialConfiguration(value);
}

void FixedIntervalStatistics::setMpiStochasticConfiguration(
    const alsutils::mpi::ConfigurationPtr& value) {
