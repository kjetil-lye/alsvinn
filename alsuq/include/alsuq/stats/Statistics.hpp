...
protected:
    ...
    mpi::ConfigurationPtr getMpiStochasticConfiguration() const;

private:
    mpi::ConfigurationPtr mpiSpatialConfiguration = nullptr;
    mpi::ConfigurationPtr mpiStochasticConfiguration = nullptr;
